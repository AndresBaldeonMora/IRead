...
export type BookInput = Omit<Book, 'id' | 'agregado_en' | 'actualizado_en'> & { id?: string };
...
export type AnimeInput = Omit<Anime, 'id' | 'agregado_en' | 'actualizado_en'> & { id?: string };
...
export type MangaInput = Omit<Manga, 'id' | 'agregado_en' | 'actualizado_en'> & { id?: string };
